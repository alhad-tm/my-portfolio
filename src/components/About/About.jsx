...
const About = () => {
  return (
    <div className={css.container} id="about">
     ...
     <span>  I'm a Self-Taught Front-end Web Developer, highly self-motivated and
        passionate about learning new things. Moreover, I'm a Tech enthusiast.
        </span> 
    
      <span>  As a base language, I am focusing on JavaScript. On my learning path, I
       ...
       <span>
        ...
        and also database knowledge in Firebase. </span>
      </div>
    </div>
  );
};
