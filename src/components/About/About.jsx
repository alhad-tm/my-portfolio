  ...
  return (
    <div className={css.container} id="about">
      <motion.div
        ...
        transition={{ duration: 1,delay:0.2}} className={css.heading}>About me</motion.div>
     ...
     >  I'm a Self-Taught Front-end Web Developer, highly self-motivated and
      ...
      initial={{ opacity: 0, y: 20 }}
      whileInView={{ opacity: 1, y: 0 }}
      transition={{ duration: 1,delay:1.4}}> As a base language, I am focusing on JavaScript. On my learning path, I
